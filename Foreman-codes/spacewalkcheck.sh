...
forward_lookup=`nslookup spacewa899lkprod > /dev/null;  if [[ $? -eq 0 ]]; then echo -e "\033[32mPassed*\033[0m"; else echo -e "\033[31mFailed*\033[0m"; fi`
...
sleep 1
echo -e "\n\t\t\t  6. Monitoring tool integration checks: $monitoring_check"
echo -e "\n\n"
echo -e "\t\t\t ==========================================================================="
